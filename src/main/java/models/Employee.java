package models;
//Model dùng để lấy dữ liệu từ databse
...
//    salaryId là khóa ngoại của nhân viên và lương
...
//       getFromResultSet dùng để lấy dữ liệu từ Db
    ...
    public Object[] toRowTable() {
        return new Object[]{
            id, name,phone,date,gender,position,salary.getSalary(),salary.getSalaryLevel()
