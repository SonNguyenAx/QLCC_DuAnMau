...
import views.User_DKDichVu;
import views.User_GuiYeuCau;
import views.User_HoaDonDichVu;
        ...
        public void mouseClicked(MouseEvent e) {
            switch(kind) {
                case "HomeView":
                    ...
                    break;
                case "DKDichVu":
                    node = new User_DKDichVu();
                    break;
                case "HoaDonDV":
                    node = new User_HoaDonDichVu();
                    break;
                case "GuiYeuCau":
                    node = new User_GuiYeuCau();
                    break;
