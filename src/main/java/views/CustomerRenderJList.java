...
public class CustomerRenderJList extends javax.swing.JPanel implements ListCellRenderer<Resident> {
    ...
    @Override
    public Component getListCellRendererComponent(JList<? extends Resident> list, Resident customer, int index, boolean isSelected, boolean cellHasFocus) {
        lbName.setText(customer.getResidentName());
        lbAddress.setText(customer.getEmail());
        lbPhoneNumber.setText(String.format("(%s)", customer.getPhone()));
        if (cellHasFocus) {
