...
public class SelectCustomerPopupView extends javax.swing.JFrame {
    ...
    DefaultListModel<Resident> customerListModel = new DefaultListModel<>();
    ...
    public DefaultListModel<Resident> getCustomerListModel() {
    ...
    public JList<Resident> getListCustomer() {
        return listCustomer;
    }

    public void setListCustomer(JList<Resident> listCustomer) {
        this.listCustomer = listCustomer;
    }

    public void renderCustomer(ArrayList<Resident> customers) {
        customerListModel.removeAllElements();
        for (Resident customer : customers) {
    ...
    private javax.swing.JList<Resident> listCustomer;
